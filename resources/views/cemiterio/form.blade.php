<div class="flex flex-wrap -mx-3 mb-6">
    <div class="w-full px-3">
        ...
        <input
            ...
            id="grid-nome" type="text" name="nome" value="{{isset($cemiterio->nome) ? $cemiterio->nome : ''}}">
    </div>
</div>
<div class="flex flex-wrap -mx-3 mb-6">
    <div class="w-full px-3">
        ...
        <input
            ...
            id="grid-endereco" type="text" name="endereco" value="{{isset($cemiterio->endereco) ? $cemiterio->endereco : ''}}">
    </div>
</div>