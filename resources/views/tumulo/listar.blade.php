...
@section('conteudo')
    <div class="container">
        <div class="row">
            <div>
                <h3 class="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white" >Lista de Túmulos </h3>
            </div>
            ...
            <table class="min-w-full table-auto border border-gray-300">
                <thead class="bg-gray-100">
                    <tr>
                        ...
                        <th class="border border-gray-300 px-4 py-2 text-left">Cemitério</th>
                        <th></th>
                    </tr>
